...
class TestKauppa(unittest.TestCase):
    ...
    def test_yksi_tuote_ja_loppunut_tuote(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
        ...
        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(1)
        kauppa.lisaa_koriin(2)  # ei lisätä, varasto 0
        kauppa.tilimaksu("pekka", "12345")
    ...
    def test_aloita_asiointi_nollaa_ostoksen(self):
        ...
        kauppa.aloita_asiointi()   # <-- tämän pitää nollata kori ja summaan
        kauppa.lisaa_koriin(2)
        kauppa.tilimaksu("pekka", "22222")

        pankki_mock.tilisiirto.assert_called_with("pekka", 42, "22222", ANY, 7)
